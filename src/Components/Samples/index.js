		...
		<div className='samples'>
			<div className='samples-wrapper'>
				<div className='sample'>
					<img src={require('../../gifs/higher_grounds.gif')} alt='Exquisite Chronicle' />
					<p><b><a href='https://www.highergroundsastoria.com' target='_blank' rel="noopener noreferrer" className='sample-link'>Higher Grounds Astoria</a></b>
				...
				<div className='sample'>
					...
					<p><b><a href='https://mindless-feast.surge.sh' rel="noopener noreferrer" target='_blank' className='sample-link'>Weather App</a></b>
				...
				<div className='sample-last'>
					<p><a href='https://github.com/curtmorgan3/portfolio-deployed' rel="noopener noreferrer" target='_blank'>See the code for this site</a></p>
				</div>
			</div>
		</div>
	)
